...
public class Main {
    ...
    public static int[] heroesHealth = {280, 270, 250, 300, 350, 200, 250, 220};
    public static int[] heroesDamage = {10, 15, 20, 0, 5, 10, 15, 20,};
    public static String[] heroesAttackType = {"Physical", "Magical", "Kinetic", "Medic", "Colem", "Lucky", "Berserk", "Thor"};
    ...
    public static void defenceColem() {
        ...
        for (int i = 0; i < heroesHealth.length; i++) {
            ...
            heroesHealth[4] -= damage * allhealht;
            System.out.println("Удача: " + damage * allhealht);
            break;
        }
    }
    ...
    public static void lucky() {
        ...
        System.out.println("Уклонение : " + chance);
    }


    public static void berserkShoot() {
        Random random = new Random();
        int randomDemage = random.nextInt(15) + 1;
        int randomC = random.nextInt(3) + 1;
        if (heroesHealth[5] > 0 && bossHealth > 0) {
            switch (randomC) {
                case 1:
                    heroesDamage[5] = (heroesDamage[5] + bossDamage) - randomDemage;
                    System.out.println("Берсерк КРИТИЧЕСКИЙ УРОН");
                    System.out.println("При блокировки урон увеличен у берсерка:" + randomDemage);
                    break;
                case 2:
                    bossDamage = 50;
                    break;
